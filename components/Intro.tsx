...
const Intro = () => {
  ...
  return (
    <div
      ref={ref}
      id='home'
      className='mt-52 mb-28 max-w-[65rem] text-center sm:mb-0 scroll-mt-[100rem] text-font-primary'
    >
      ...
      <div className='flex flex-col sm:flex-row items-center justify-center gap-5 px-4 text-lg font-medium'>
        <Link
          href='#contact'
          className='group bg-[#144552] px-7 py-3 flex items-center gap-2 rounded-xl outline-none focus:scale-105 hover:scale-105 hover:bg-[#006466] active:scale-100 transition'
          onClick={() => {
